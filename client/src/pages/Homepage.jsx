...
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-800 overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-5xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {/* Premium badge */}
          <div className="inline-flex items-center gap-2 bg-emerald-500/20 backdrop-blur-sm border border-emerald-400/30 rounded-full px-6 py-2 mb-8">
          ...
          <p className="text-xl md:text-2xl text-emerald-100/90 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button 
              className="group relative bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-12 py-6 text-xl font-bold rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-emerald-500/25" 
            ...
            <Button 
              variant="outline" 
              className="border-2 border-emerald-400/50 bg-transparent text-emerald-100 hover:bg-emerald-500/20 px-8 py-6 text-lg font-semibold rounded-2xl backdrop-blur-sm transition-all duration-300"
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-gray-50 to-emerald-50/50 relative overflow-hidden">
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-slate-800 via-emerald-900 to-slate-900 relative overflow-hidden">
        {/* Background pattern */}
      ...
      <section ref={productsRef} className="py-24 px-4 bg-gradient-to-br from-gray-50 via-white to-emerald-50/30">
