      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-100 to-teal-50">
        ...
        <section className="pt-20 pb-12 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            {/* Search Bar */}
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto mb-8 px-4 sm:px-0">
              <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-full shadow-sm px-4 py-2">
                ...
                <input
                  ...
                  className="flex-1 bg-transparent outline-none border-0 focus:ring-0 text-base sm:text-lg py-2"
                />
                <Button
                  type="submit"
                  className="bg-emerald-600 hover:bg-emerald-700 text-white rounded-full px-5 sm:px-6 py-2"
                >
                  Search
                </Button>
              </div>
